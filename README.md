...
```xml
<script src="https://cdn.jsdelivr.net/gh/HallGold/live2d-widget@latest/autoload.js"></script>
```
...
- 如果你能够通过 `ssh` 访问你的主机，请把整个仓库克隆到服务器上。执行：
  ...
  git clone https://github.com/HallGold/live2d-widget.git
  ```
